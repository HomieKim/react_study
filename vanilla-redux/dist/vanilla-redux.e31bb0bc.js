...
var btnDecrease = document.querySelector('#decrease'); // 액션이름 설정(액션 명은 고유해야 합니다.)

var TOGGLE_SWITCH = 'TOGGLE_SWITCH';
var INCREASE = 'INCRESE';
...
var store = createStore(reducer); // render함수 만들기(상태가 업데이터 될 때마다 호출 됨)
...
render(); // subcribe합수의 파라미터로 함수형태의 값을전달, 추후 액션이 발생하여 상태가 업데이트 될 때마다 호출 됨

store.subscribe(render); // 액션 발생시키기 , 액셔을 방생시키는 것을 디스패치라고함, 스토어의 내장함수 사용
...
},{"redux":"node_modules/redux/es/redux.js"}],"C:/Users/김호민/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["C:/Users/김호민/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","index.js"], null)
